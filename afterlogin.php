  ...
  <body data-spy="scroll" data-target="#navbar" data-offset="150">
        ...
        <nav class="navbar navbar-light bg-faded navbar-fixed-top" id="navbar">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="sidevideo.html"> Courses</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="https://goo.gl/forms/e0tKZvLPYqeA1e5z1">Feedback</a>
            </li>
          
           
            <button class="btn btn-success" type="button" onclick="my()"  ><a href="afterlogout.php">Logout
        ...
        <div class="jumbotron" id="jumbotron">
          <h1 class="display-3" style="color: white;">Welcome </h1>
          <p style="color:white"><h2>"An Investment in Knowedge pays the best interest"</h2></p>
          <hr class="m-y-2">
